...
const file = "src/components/dataComponents/TEXTBOX.svelte";

// (15:2) {#if HelpDescription}
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div, file, 15, 3, 358);
		},
...
function create_fragment(ctx) {
	var div1, label, t0, t1, div0, input, t2, t3, br;
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(input, file, 12, 2, 271);
...
class TEXTBOX extends SvelteComponentDev {
	constructor(options) {
		...
		if (ctx.DisplayTypeShortCode === undefined && !('DisplayTypeShortCode' in props)) {
			console.warn("<TEXTBOX> was created without expected prop 'DisplayTypeShortCode'");
		}
		if (ctx.ShortCode === undefined && !('ShortCode' in props)) {
			console.warn("<TEXTBOX> was created without expected prop 'ShortCode'");
		}
		if (ctx.HelpDescription === undefined && !('HelpDescription' in props)) {
			console.warn("<TEXTBOX> was created without expected prop 'HelpDescription'");
		}
