...
const DROPDOWN = __chunk_1.create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="data-component-container"${(v => v == null ? "" : ` data-short-code="${__chunk_1.escape(ShortCode)}"`)(ShortCode)}>
		...
		<div class="input-container">
			<select${(v => v == null ? "" : ` id="${__chunk_1.escape(ShortCode)}"`)(ShortCode)}>
				<option value="TODO populate from AllowedValues">TODO populate from AllowedValues</option>
			</select>
