import { S as SvelteComponentDev, i as init, s as safe_not_equal, e as element, t as text, c as claim_element, b as children, d as claim_text, f as detach, g as attr, h as add_location, j as insert, k as append, w as set_data, a as space, n as noop, K as onMount } from './chunk.6be85367.js';
...
const file = "src/components/dataComponents/DATEPICKER.svelte";

// (39:2) {#if HelpDescription}
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div, file, 39, 3, 1115);
		},
...
function create_fragment(ctx) {
	var div1, label, t0, t1, div0, input, t2;
	...
	return {
		...
		l: function claim(nodes) {
			...
			input = claim_element(div0_nodes, "INPUT", { id: true, type: true, autocomplete: true }, false);
		...
		h: function hydrate() {
			...
			add_location(label, file, 33, 1, 953);
			attr(input, "id", ctx.ShortCode);
			attr(input, "type", "text");
			attr(input, "autocomplete", "off");
			add_location(input, file, 36, 2, 1028);
			attr(div0, "class", "input-container");
			add_location(div0, file, 35, 1, 996);
			attr(div1, "class", "data-component-container");
			div1.dataset.shortCode = ctx.ShortCode;
			add_location(div1, file, 32, 0, 883);
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	const writable_props = ['DisplayTypeShortCode', 'ShortCode', 'Label', 'HelpDescription'];
...
class DATEPICKER extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance, create_fragment, safe_not_equal, ["DisplayTypeShortCode", "ShortCode", "Label", "HelpDescription"]);

		const { ctx } = this.$$;
		const props = options.props || {};
		if (ctx.DisplayTypeShortCode === undefined && !('DisplayTypeShortCode' in props)) {
			console.warn("<DATEPICKER> was created without expected prop 'DisplayTypeShortCode'");
		}
		if (ctx.ShortCode === undefined && !('ShortCode' in props)) {
			console.warn("<DATEPICKER> was created without expected prop 'ShortCode'");
		}
		...
		if (ctx.HelpDescription === undefined && !('HelpDescription' in props)) {
			console.warn("<DATEPICKER> was created without expected prop 'HelpDescription'");
		}
	}
