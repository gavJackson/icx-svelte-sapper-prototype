...
var __chunk_3 = require('./chunk-019239cc.js');
...
const Index$1 = __chunk_1.create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	let { posts } = $$props;
...
const Index$2 = __chunk_1.create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<h1>Sample Views</h1>

	<p>
		I have created a custom route containing the path to the json file to load which contains the view with its data components.

	</p>

	<ul>
		<li><a rel="prefetch" href="view/assets-views-testForm1.json">testForm1.json</a> - APv2 Prototype Stage 1</li>
		<li><a rel="prefetch" href="view/assets-views-testForm2.json">testForm2.json</a> - Virtual List Rendering</li>
	</ul>
	`;
});
...
const VirtualList = __chunk_1.create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	async function refresh(items, viewport_height, itemHeight) {
		...
		await __chunk_1.tick(); // wait until the DOM is up to date
		...
		while (content_height < viewport_height && i < items.length) {
			...
			if (!row) {
				...
				await __chunk_1.tick(); // render the newly visible row
				row = rows[i - start];
			}
	...
	return `<svelte-virtual-list-viewport style="height: ${__chunk_1.escape(height)};" class="svelte-1tqh76q"${__chunk_1.add_attribute("this", viewport)}>
		<svelte-virtual-list-contents style="padding-top: ${__chunk_1.escape(top)}px; padding-bottom: ${__chunk_1.escape(bottom)}px;" class="svelte-1tqh76q"${__chunk_1.add_attribute("this", contents)}>
			${__chunk_1.each(visible, (row) => `<svelte-virtual-list-row class="svelte-1tqh76q">
...
const Slug$1 = __chunk_1.create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	let $viewDefinition = __chunk_1.get_store_value(viewDefinition), $dataComponents = __chunk_1.get_store_value(dataComponents);
	...
	do {
		...
		$$rendered = `${($$result.head += `<title>View</title>`, "")}

		<form autocomplete="off">
			<header>
				<h1>${__chunk_1.escape($viewDefinition.ScreenName)}</h1>

				<p>${__chunk_1.escape($viewDefinition.ScreenHelpDescription)}</p>
			</header>

			<fieldset class="svelte-1om8m3b">
				<legend class="svelte-1om8m3b">${__chunk_1.escape($viewDefinition.ScreenName)}</legend>
					${ $viewDefinition.UseVirtualList ? `<div class="view-container svelte-1om8m3b">
							${__chunk_1.validate_component(VirtualList, 'VirtualList').$$render($$result, {
			...
			default: ({ item }) => `
								${__chunk_1.validate_component(__chunk_3.DCRenderer, 'DCRenderer').$$render($$result, Object.assign(item), {}, {})}
							`
		})}
						</div>

						<p>showing items ${__chunk_1.escape(start)}-${__chunk_1.escape(end)}</p>` : `${__chunk_1.each($dataComponents, (item) => `${__chunk_1.validate_component(__chunk_3.DCRenderer, 'DCRenderer').$$render($$result, Object.assign(item), {}, {})}`)}` }
...
const Nav = __chunk_1.create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<nav class="svelte-d8ys7h">
		<ul class="svelte-d8ys7h">
			<li class="svelte-d8ys7h"><a class="${__chunk_1.escape(segment === undefined ? "selected" : "")} svelte-d8ys7h" href=".">home</a></li>
			<li class="svelte-d8ys7h"><a class="${__chunk_1.escape(segment === "about" ? "selected" : "")} svelte-d8ys7h" href="about">about</a></li>
			<li class="svelte-d8ys7h"><a class="${__chunk_1.escape(segment === "view" ? "selected" : "")} svelte-d8ys7h" href="view">view</a></li>


			<li class="svelte-d8ys7h"><a rel="prefetch" class="${__chunk_1.escape(segment === "blog" ? "selected" : "")} svelte-d8ys7h" href="blog">blog</a></li>
		</ul>
	</nav>`;
});
...
const css$6 = {
	code: "main.svelte-x5nbh{position:relative;max-width:56em;background-color:#f7f7f7;padding:2em;margin:0 auto;box-sizing:border-box}",
	map: "{\"version\":3,\"file\":\"_layout.svelte\",\"sources\":[\"_layout.svelte\"],\"sourcesContent\":[\"<script>\\n\\timport Nav from '../components/Nav.svelte';\\n\\n\\texport let segment;\\n</script>\\n\\n<style>\\n\\tmain {\\n\\t\\tposition: relative;\\n\\t\\tmax-width: 56em;\\n\\t\\tbackground-color: #f7f7f7;\\n\\t\\tpadding: 2em;\\n\\t\\tmargin: 0 auto;\\n\\t\\tbox-sizing: border-box;\\n\\t}\\n</style>\\n\\n<Nav {segment}/>\\n\\n<main>\\n\\t<slot></slot>\\n</main>\"],\"names\":[],\"mappings\":\"AAOC,IAAI,aAAC,CAAC,AACL,QAAQ,CAAE,QAAQ,CAClB,SAAS,CAAE,IAAI,CACf,gBAAgB,CAAE,OAAO,CACzB,OAAO,CAAE,GAAG,CACZ,MAAM,CAAE,CAAC,CAAC,IAAI,CACd,UAAU,CAAE,UAAU,AACvB,CAAC\"}"
};
...
const manifest = {
	...
	pages: [
...

		{
			...
			pattern: /^\/view\/?$/,
			parts: [
				{ name: "view", file: "view/index.svelte", component: Index$2 }
			]
		},

		{
			...
			parts: [
				null,
				{ name: "view_$slug", file: "view/[slug].svelte", component: Slug$1, preload: preload$2, params: match => ({ slug: d(match[1]) }) }
			]
		}
	],
